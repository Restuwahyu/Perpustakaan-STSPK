            ...
            <div class="col-12 col-sm-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('tambahUser') }}" method="POST" novalidate>
                            @csrf
                            @method('POST')
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="email" name="user_email"
                                            ...
                                            id="email" value="{{ old('user_email') }}" required>
                                    </div>
                                    @error('user_email')
                                        <span class="text-danger">({{ $message }})</span>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" name="user_tanggal_lahir"
                                        ...
                                        value="{{ old('user_tanggal_lahir') }}" required />
                            ...
                            <div class="form-group row">
                                <label for="nama" class="col-sm-4 col-form-label">Role*
                                    ...
                                    <i class="mdi mdi-information ml-auto" data-toggle="popover" data-placement="top"
                                        data-html="true"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="tambahModalLabel">Konfirmasi Tambah
                                            </h5>
