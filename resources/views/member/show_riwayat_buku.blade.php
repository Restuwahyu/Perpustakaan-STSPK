    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center ">
                <div class="col-md-8">
                    <div class="page-title-box">
                        <h4 class="page-title">List Riwayat Peminjaman Buku ({{ $member->member_nama }})</h4>
                        <ol class="breadcrumb">
                            @if (Auth::check() && $type == null)
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('showMember') }}">List Member</a>
                                </li>
                                <li class="breadcrumb-item active">List Riwayat Peminjaman Buku</li>
                            @endif
                        </ol>
                    </div>
                </div>
