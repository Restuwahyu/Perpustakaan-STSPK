    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center ">
                <div class="col-md-8">
                    <div class="page-title-box">
                        <h4 class="page-title">Ganti Password {{ session('member')['member_nama'] }}</h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('dashboardMember') }}">Dashboard</a>
                            </li>
            ...
            <div class="col-12 col-sm-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('gantiPasswordMember') }}" novalidate>
                            @csrf
                            @method('PUT')

                            <div class="form-group row">
                                <label for="current_password" class="col-sm-4 col-form-label">Password
                                    Lama </label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="password" id="current_password" name="current_password"
                                            class="form-control @error('current_password') is-invalid @enderror"
                                            value="{{ session()->get('current_password') }}" required>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="password" id="new_password" name="new_password"
                                            ...
                                            value="{{ session()->get('new_password') }}" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-toggle="password-toggle"
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="password" id="password_confirmation" name="password_confirmation"
                                            ...
                                            value="{{ session()->get('password_confirmation') }}" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text" data-toggle="password-toggle"
                            ...
                            <div class="text-right">
                                <a href="{{ route('dashboardMember') }}" class="btn btn-danger mr-2"
                                    style="color: white">Batal</a>

                                <a class="btn btn-success" data-toggle="modal"
                                    data-target="#gantiPasswordModal{{ session('member')['member_id'] }}"
                                    style="color: white">
                                    Ganti Password
                                </a>
                            </div>
                            ...
                            <div class="modal fade" id="gantiPasswordModal{{ session('member')['member_id'] }}"
