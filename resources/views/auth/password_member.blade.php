                ...
                <div class="col-lg-8">
                    <div class="card card-pages shadow-none mt-4">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('ganti_password_member') }}">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text"
                                                    data-toggle="password-toggle"data-target="new_password"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text"
                                                    data-toggle="password-toggle"data-target="password_confirmation"
                                                    style="background-color: white; border-left: none;">
                                                    <i class="fa fa-eye-slash" aria-hidden="true"></i>
                                                </span>
                                            </div>
                                ...
                                <div class="text-right">
                                    <input type="hidden" name="type" value="ganti_password">
                                    <input type="hidden" name="id_member_reset" value="{{ $member->member_id }}">
